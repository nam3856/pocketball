...
namespace LobbyRelaySample.UI
{
    ...
    public class ColorLobbyUI : MonoBehaviour
    {
        ...
        {
            if (m_UseLocalLobby)
                SetLobby(MultiplayManager.Instance.LocalLobby);
        }
        ...
        public void ToggleWhite(bool toggle)
        {
            if (!toggle)
                return;
            MultiplayManager.Instance.SetLocalLobbyColor(0);
        }
        ...
        public void ToggleOrange(bool toggle)
        {
            if (!toggle)
                return;
            MultiplayManager.Instance.SetLocalLobbyColor(1);
        }
        ...
        public void ToggleGreen(bool toggle)
        {
            if (!toggle)
                return;
            MultiplayManager.Instance.SetLocalLobbyColor(2);
        }
        ...
        public void ToggleBlue(bool toggle)
        {
            if (!toggle)
                return;
            MultiplayManager.Instance.SetLocalLobbyColor(3);
        }
